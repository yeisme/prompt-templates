...
适用：`ai-drama-character-assets@1.0.0`（`promptrepo://official/video/ai-drama-character-assets@1.0.0`；2026-09-05 由 `-v2@2.0.0` 内容晋升为正式版本，旧 1.x 目录已移除）。当前 maturity=`exploratory`；本文描述该正式版内容。
