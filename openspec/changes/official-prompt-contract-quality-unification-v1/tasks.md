...
- [x] 4.3 升级 writing/learning/marketing/short-drama 第三批模板。
  - Evidence（2026-09-07）：`writing/longform-outline`（6 inputs，`sha256:074f9dd45eaf`）、`learning/socratic-study-plan`（3 inputs，`sha256:08f0398a5dd8`）、`marketing/xhs-campaign-copy`（4 inputs，`sha256:b334956c74fa`）、`video/short-drama-character-consistency`（4 inputs，`sha256:fe77d912edf1`）补齐 en 正文 untrusted source 边界 + 逐字段 Output contract（evidence_gaps/risk_review/conflicts 显式兜底，zh-CN 镜像同步）、main contract（source_material/verified_benefits/character_bible/reference_assets/previous_shot 标 sensitive）、document descriptor（required capabilities：longform_outlining/socratic_tutoring/xhs_copywriting/short_drama_continuity）、语义输出 schema 与 1 valid + 1 invalid fixture（`fixture validate` 全 success，short-drama valid case 含空 conflicts 数组与完整 continuity_locks）；`docs/review-checklist.zh-CN.md` 与 `docs/failure-modes.zh-CN.md` 落地。catalog build 连续两次同 digest `sha256:0f91b3cc9d5de9132f4ca33057776a8c66c98afc2df7efbe8344c35739b945ac`，validate success，openspec 20 passed。
